...
const navSections: NavSection[] = [
  ...
  },
  {
    title: "Services",
    items: [
      { label: "Parking", to: "/services/parking" },
      { label: "Public Transit", to: "/services/public-transport" },
    ],
  },
  {
    title: "Insights",
    items: [
      ...
      { label: "Parking Management", to: "/provider/parking", roles: ["PROVIDER", "ADMIN"] },
    ],
  },
  {
    title: "Admin",
      ...
      <nav className="flex-1 overflow-y-auto px-3 py-5">
        {visibleNavSections.map((section) => (
          <div key={section.title} className="mb-6">
            <p className="px-2 pb-2 text-xs font-semibold uppercase tracking-[0.14em] text-gray-500">
              {section.title}
            </p>
