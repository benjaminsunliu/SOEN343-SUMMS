...
public class PaymentController {
        ...
        public ProcessReservationPaymentResponse processReservationPayment(
                ...
                if (rentalLifecycleService.hasActiveTripForCitizen(userId)) {
                        throw new ResponseStatusException(
                                        HttpStatus.CONFLICT,
                                        "Citizen already has an active trip. End it before paying for a new reservation.");
                }
        ...
        public ProviderPaymentAnalyticsResponse getCurrentProviderAnalytics(Authentication authentication) {
                ...
                PaymentTransactionService.ProviderPaymentAnalytics analytics = paymentTransactionService
                                .getProviderAnalytics(user.getId());
