...
//             .evCharging(true)
//             .security(true)
//             .amenityTags(List.of("Covered", "24h", "EV Charging", "Security"))
//             .build(),
...
//             .evCharging(false)
//             .security(true)
//             .amenityTags(List.of("24h", "Security"))
//             .build(),

//         ParkingFacilityDTO.builder()
//             .facilityId(4L)
//             .name("ABM Parking Centre-Eaton")
//             .address("677 rue Ste-Catherine O.")
//             .city("Montreal")
//             .distanceKm(0.3)
//             .pricePerHour(4.50)
//             .rating(4.8)
...
//         ParkingFacilityDTO.builder()
//             .facilityId(5L)
//             .name("BestPark Quartier Latin")
//             .address("300 rue Ontario E.")
//             .city("Montreal")
//             .distanceKm(0.8)
//             .pricePerHour(2.25)
//             .rating(3.9)
...
//                 .peek(f -> f.setEstimatedTotal(
//                         Math.round(f.getPricePerHour() * duration * 100.0) / 100.0))
...
@Component
@Primary
@RequiredArgsConstructor  // ← replaces the old empty constructor
public class MockParkingAdapter implements IParkingService {
